...
namespace Piro.Infrastructure.Migrations
{
    ...
    [Migration("20260423130634_AddOidcProviderConfigs")]
    partial class AddOidcProviderConfigs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piro.Domain.Entities.AlertConfigTrigger", b =>
                {
                    ...
                    b.HasKey("AlertConfigId", "TriggerId");

                    b.HasIndex("TriggerId");

                    b.ToTable("AlertConfigTriggers");
                });
            ...
            modelBuilder.Entity("Piro.Domain.Entities.Trigger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Piro.Domain.Entities.AlertConfigTrigger", b =>
                {
                    b.HasOne("Piro.Domain.Entities.AlertConfig", "AlertConfig")
                        .WithMany("AlertConfigTriggers")
                        .HasForeignKey("AlertConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Piro.Domain.Entities.Trigger", "Trigger")
                        .WithMany("AlertConfigTriggers")
            ...
            modelBuilder.Entity("Piro.Domain.Entities.AlertConfig", b =>
                {
                    b.Navigation("AlertConfigTriggers");
                });
