...
namespace Piro.Infrastructure.Migrations
{
    ...
    [Migration("20260727180144_DeviceTokenPushPublicKey")]
    partial class DeviceTokenPushPublicKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piro.Domain.Entities.AlertConfig", b =>
                {
                    ...
                    b.Property<int>("MinFailingRegions")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("Piro.Domain.Entities.DeviceToken", b =>
                {
                    ...
                    b.Property<string>("PushPublicKey")
                        .HasMaxLength(128)
            ...
            modelBuilder.Entity("Piro.Domain.Entities.ApiKey", b =>
                {
                    b.HasOne("Piro.Domain.Entities.Check", null)
                        .WithMany()
                        .HasForeignKey("CheckId")
                        .OnDelete(DeleteBehavior.Cascade);
