...
public interface IAlertRepository
{
    ...
    /// <summary>Counts distinct services with an active Alert whose AlertConfig has CreateIncident = true,
    /// used by Merge correlation to decide whether to elevate/merge.</summary>
    Task<int> CountConcurrentActiveAlertingServicesAsync(CancellationToken ct = default);
    ...
    /// </summary>
    Task<(IEnumerable<AlertSummaryRow> Items, int TotalCount)> GetPagedSummaryAsync(AlertQueryParams query, CancellationToken ct = default);
