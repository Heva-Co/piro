  ...
  return (
    <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 flex items-center gap-3 mb-6">
      ...
      <p className="text-sm text-amber-800">
        No default worker connected — checks that require the default worker are not executing. Go to <strong>Workers</strong> to register and connect a default worker.
      </p>
    </div>
  );
}
